...
const SECTIONS: Record<string, HubSection> = {
  home: {
    ...
    tabs: [
      ...
      {
        value: "trust", label: "Trust Strip", icon: Sparkles,
        editors: [
          { pageKey: "home_trust", label: "Trust Strip", icon: Sparkles, description: "Four expertise/trust items below the hero." },
        ],
      },
      {
        value: "find_journey", label: "Find Journey", icon: Compass,
        editors: [
          { pageKey: "home_find_journey", label: "Find Your Journey", icon: Compass, description: "Journey-type card grid section." },
        ],
      },
      {
        value: "why", label: "Why Baobab", icon: Sparkles,
        editors: [
          { pageKey: "home_why_baobab", label: "Why Baobab — Pillars", icon: Sparkles, description: "Numbered pillars explaining why Baobab Collective." },
        ],
      },
      {
        value: "founders", label: "Founders", icon: UsersIcon,
        editors: [
          { pageKey: "home_founders", label: "Meet the Founders", icon: UsersIcon, description: "Founder profile cards and narrative copy." },
        ],
      },
      {
        value: "impact", label: "Journey Impact", icon: Globe,
        editors: [
          { pageKey: "home_impact", label: "Journey Impact", icon: Globe, description: "Responsible tourism / conservation pillars." },
        ],
      },
      {
        value: "how", label: "How It Works", icon: Bell,
        editors: [
          { pageKey: "home_how_it_works", label: "How It Works — Steps", icon: Bell, description: "Four-step planning process section." },
        ],
      },
      {
        value: "final_cta", label: "Final CTA", icon: Megaphone,
        editors: [
          { pageKey: "home_final_cta", label: "Final CTA Block", icon: Megaphone, description: "'Your Kenya is waiting' closing CTA." },
        ],
      },
      {
