                      ...
                      >
                        ...
                        >
                          ...
                          {isSelected && !isDragging && (
                            <span className="absolute -inset-3.5 rounded-full bg-gold/40 animate-ping pointer-events-none" />
                          )}

                          {/* Drag aura */}
                          {isDragging && (
                            <span className="absolute -inset-5 rounded-full bg-gold/50 animate-pulse pointer-events-none ring-4 ring-gold/40" />
                          )}
                          ...
                          <div
                            className={`absolute top-full left-1/2 ${labelOffset} whitespace-nowrap px-3 py-1 rounded-full text-[11px] font-bold tracking-wider transition-all pointer-events-none shadow-lg ${
                              isSelected || isDragging
                                ? "bg-gold text-gold-foreground scale-110 z-30 ring-2 ring-gold/40 shadow-gold/40"
                                : "bg-gold text-gold-foreground group-hover:bg-gold/90 group-hover:scale-105"
                            }`}
                          >
                            {dest.name}
                          </div>
